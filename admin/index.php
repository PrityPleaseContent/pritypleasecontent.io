  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php?page=pesanan"><i class="fa fa-cart-arrow-down"></i> <span>Pesanan</span></a></li>
        <li><a href="index.php?page=laporan"><i class="fa fa-bar-chart"></i> <span>Laporan</span></a></li>
        <li class="treeview">
          <a href="#">
