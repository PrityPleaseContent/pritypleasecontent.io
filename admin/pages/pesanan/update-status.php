...
<form action="pages/pesanan/update-status.php" method="post">
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="status" id="status">
            <option value="6" <?php if ($data['status']==6) echo 'selected';?> >Ditahan</option>
            ...
            <option value="3" <?php if ($data['status']==3) echo 'selected';?> >Selesai</option>
            <option value="4" <?php if ($data['status']==4) echo 'selected';?> >Dibatalkan</option>
            <option value="5" <?php if ($data['status']==5) echo 'selected';?> >Dana dikembalikan</option>
...
<script>
    ...
    if (status=='6'){
            ...
            $("#keterangan").val('Kami telah selesai memproses pesanan Anda.');
        } else if  (status=='4'){
            $("#keterangan").val('Pesanan anda telah kami batalkan dengan alasan ...');
        }  else if  (status=='5'){
            $("#keterangan").val('Dana yang telah dibayar telah kami kembalikan.');
        } else {
            $("#keterangan").val('');
    }
