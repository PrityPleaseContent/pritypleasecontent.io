...
<?php
    ...
    if ($jum<1){
        echo"<div class='alert alert-info'>Pelanggan belum melakukan konfirmasi.</div>";
...
?>
    ...
    <div class="form-group">
        <button type="button" name="konfirmasi" id="konfirmasi" class="btn btn-primary">Konfirmasi</button>
    </div>
