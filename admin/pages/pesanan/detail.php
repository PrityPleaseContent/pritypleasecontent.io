...
<section class="invoice">
    ...
    <div class="col-xs-12">
        <button type="button" id="update_status" class="btn btn-primary" style="margin-right: 5px;" nomor_pesanan="<?php echo $_GET['nomor_pesanan'];?>">
        <i class="fa fa-download"></i> Update Status
        </button>
        <button type="button" id="konfirmasi_pembayaran" nomor_pesanan="<?php echo $_GET['nomor_pesanan'];?>" class="btn btn-success"><i class="fa fa-credit-card"></i> Konfirmasi Pembayaran
        </button>
        <a href="pages/pesanan/cetak/invoice-print.php?nomor_pesanan=<?php echo $_GET['nomor_pesanan']; ?>" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print</a>
