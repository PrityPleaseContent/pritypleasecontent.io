...
<div class="women-product">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#detail_pesanan">DETAIL PESANAN</a></li>
        <li><a data-toggle="tab" href="#biaya">BIAYA</a></li>
        <li><a data-toggle="tab" href="#status">STATUS</a></li>
        <li><a data-toggle="tab" href="#pembayaran">PEMBAYARAN</a></li>
    </ul>
