        ...
        <thead>
            ...
            <tbody>
                <?php
                    ...
                    $sql="select * from pesanan where kode_pelanggan='$kode_pelanggan' order by id_pesanan desc";
                    ...
                    while ($data = mysqli_fetch_array($hasil)):
                        ...
                        while ($row = mysqli_fetch_array($result)):
                            ...
                            switch ($data['status']){
                                ...
                                case '1' : $status="<span class='label label-primary'>Pembayaran tertunda</span>";break;
                                case '2' : $status="<span class='label label-info'>Sedang diproses</span>";break;
                                case '3' : $status="<span class='label label-success'>Selesai</span>";break;
                                case '4' : $status="<span class='label label-danger'>Dibatalkan</span>";break;
                                case '5' : $status="<span class='label label-warning'>Dana dikembalikan</span>";break;
                                default :  $status='-';
                            }
